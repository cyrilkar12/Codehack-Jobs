...
import com.codehack.springquartz.config.AutoWiringSpringBeanJobFactory;
...
public class QrtzScheduler {
    ...
    public JobDetail jobDetail() {
        ...
        return newJob().ofType(FpGrowthJob.class).storeDurably().withIdentity(JobKey.jobKey("Qrtz_Job_Detail")).withDescription("Invoke Sample Job service...").build();
    }

    @Bean
    public Trigger trigger(JobDetail job) {

        int frequencyInSec = 1000000000;
